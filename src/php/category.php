...
?>
        ...
        <ul>
            ...
            ?>
                    <li><span class="tree_label" onclick="SpawnDialog('<?php echo $entry->title ?>', '<?php echo $entry->link ?>', '<?php echo $entry->info ?>', '<?php echo $entry->color ?>', '<?php echo $entry->thumbnail ?>')"><?php echo $entry->title ?></span></li>
